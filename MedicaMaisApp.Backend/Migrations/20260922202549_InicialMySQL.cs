        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrosHumor_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrosPressao", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistrosPressao_Usuarios_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrosHumor_UsuarioId",
                table: "RegistrosHumor",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrosPressao_UsuarioId",
                table: "RegistrosPressao",
                column: "UsuarioId");
